                    ...
                    <form method="POST" action="{{ route('admin.update') }}" class="forms-sample" enctype="multipart/form-data">
                       ...
                       <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img id="showImage" class="wd-65 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile" style="border: 1px solid #000;">
                        </div>
