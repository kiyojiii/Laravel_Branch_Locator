...
<head>
    ...
    <title>MSU-IIT NMPC - Dashboard</title>
                ...
                <div class="row portfolio-container" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area1">
                        ...
                        <div class="portfolio-info">
                            <h4>Tibanga-Main</h4>
                            <p>Area 1</p>
                            <a href="{{ asset('backend/assets3/images/tibanga-branch.jpg') }}" data-gallery="portfolioGallery" style="width: 600px; height: 300px;" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area1">
                        ...
                        <div class="portfolio-info">
                            <h4>Bulua Branch</h4>
                            <p>Area 1</p>
                            <a href="{{ asset('backend/assets3/images/bulua.jpg') }}" data-gallery="portfolioGallery" style="width: 600px; height: 300px;" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area1">
                        ...
                        <div class="portfolio-info">
                            <h4>Carmen Branch</h4>
                            <p>Area 1</p>
                            <a href="{{ asset('backend/assets3/images/no_image.jpg') }}" data-gallery="portfolioGallery" style="width: 600px; height: 300px;" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area1">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 1</p>
                            <a href="{{ asset('backend/assets3/images/manticao.jpg') }}" data-gallery="portfolioGallery" style="width: 600px; height: 300px;" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area1">
                        ...
                        <div class="portfolio-info">
                            <h4>Puerto Branch</h4>
                            <p>Area 1</p>
                            <a href="{{ asset('backend/assets3/images/puerto.jpg') }}" data-gallery="portfolioGallery" style="width: 600px; height: 300px;" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            <h4>Pala-O Branch</h4>
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/palao.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/buruun.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/no_image.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/poblacion.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/suarez.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area2">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 2</p>
                            <a href="{{ asset('backend/assets3/images/tubod.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            <h4>Butuan Branch</h4>
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/butuan.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            <h4>Davao Branch</h4>
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/davao.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/no_image.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/bacolod.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/pagadian.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-area3">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Area 3</p>
                            <a href="{{ asset('backend/assets3/images/tubodldn.png') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
