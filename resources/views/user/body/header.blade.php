<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <div class="row g-0 p-1">
                  ...
                  <div class="col-3 text-center">
                    <a href="{{ route('user.user_profile') }}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="instagram" class="icon-lg mb-1"></i><p class="tx-12">Profile</p></a>
                  </div>
                </div>
              ...
              <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                ...
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="{{ route('user.user_profile') }}" class="text-body ms-0">
