    ...
    <div class="row">
                    ...
                    <h6 class="card-title">
                        <nav class="page-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Coordinates</li>
                            </ol>
                        </nav>
                    </h6>
                    <div class="container">
        ...
        <script>
            ...
            marker.on('dragend', function() {
                ...
                $('#coordinates').val(coordinates.lat + "," + coordinates.lng).keyup()
                $('#latitude').val(coordinates.lat).keyup()
                $('#longitude').val(coordinates.lng).keyup()
            })
        </script>
